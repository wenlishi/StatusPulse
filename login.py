...
def check_journal_status():
    ...
    try:
        with sync_playwright() as p:
            ...
            # 登录和导航
            page.goto("https://www.editorialmanager.com/bae/default2.aspx", wait_until="domcontentloaded") # 我们不等待所有图片、广告都加载完 (load)，而是只等待HTML文档本身加载并解析完毕 (domcontentloaded)，这通常足够我们进行后续的登录操作了
